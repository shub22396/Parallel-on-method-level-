...
public class Test1
{
    ...
    public void testSetUp(String browser, String version, String platform, String resolution, Method method) throws Exception
    {
        String platformName = System.getenv("HYPEREXECUTE_PLATFORM") != null ? System.getenv("HYPEREXECUTE_PLATFORM") : platform;
        
        DesiredCapabilities capabilities = new DesiredCapabilities();

        capabilities.setCapability("build", "buidx");
    ...
    public void test1_element() throws InterruptedException
    {
        driver.get(testURL);
        Thread.sleep(5000);
    ...
    @Test(description="To Do App on React App")
    public void test1_element33() throws InterruptedException
    {
        driver.get(testURL);
        Thread.sleep(5000);
