...
public class Test2
{
    ...
    public void testSetUp(String browser, String version, String platform, String resolution, Method m) throws Exception
    {
    ...
    public void test2_element() throws InterruptedException
    {
        driver.get(testURL);
        Thread.sleep(5000);
